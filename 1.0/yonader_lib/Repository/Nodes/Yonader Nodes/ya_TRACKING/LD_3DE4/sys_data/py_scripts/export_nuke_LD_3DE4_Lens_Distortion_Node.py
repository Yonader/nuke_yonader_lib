...
# Internal comment: v1.10 [2021-08-13] Allow to load as module, without dialog popping up.
...
# main
def main_export_nuke_ld_3de4():
	global nuke_node_req
	try:
# camera and lens
		id_cam = tde4.getCurrentCamera()
		id_lens = tde4.getCameraLens(id_cam)
